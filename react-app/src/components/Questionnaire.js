...
const Questionnaire = ({setShowSignUp, setQuestionAnswers, setNext, setShowQuestionnaire, setSubmit, showQuestionnaire, setQuestionsComplete}) => {
    ...
    const questionObj = {
        ...
        4: {Question: "Is it important that your Pokémon is happy?", Options: {0: "It's not as important as becomming League Champion", 1: "My Pokémon's happiness is my highest priority!", 2: "I hope that my pokémon and I are having fun adventuring.", 3: "It's important because a happy pokémon is a better battler"}},
        ...
        7: {Question: "Someone offers to trade a high level Lapras with your original starter companion.", Options: {0: "And abandon my friend? I think not.", 1: "Please. I'll be able to train my starter to far exceed that pokémon", 2: "An instant upgrade to my party? Of course!", 3: "Only if it knows surf. I still need to visit the islands!"}},
        8: {Question: "Your Pokémon knocks over your gaming system and breaks it... you", Options: {0: "Forgive your Pokémon and clean it up. Mistakes happen!", 1: "Clean it up, but you are going to have to go out and battle to make that money back! ", 2: "Reprimand them and no treats for a week!", 3: "Who hasn't thrown their Wiimote through the TV? Laugh it off."}},
        9: {Question: "You have a ditto, you make him transform into...", Options: {0: "Another ditto.", 1: "Whatever Pokémon is needed to face my current opponent.", 2: "Mr. Mime, he doesn't get enough representation.", 3: "Mewtwo, the most powerful Pokémon!"}},
        10: {Question: "What do you look for in Pokémon?", Options: {0: "The strongest ones.", 1: "The ones I feel like I connect with.", 2: "The ones that will balance out my team.", 3: "The ones that look the coolest, cutest, etc."}},
        ...
        18: {Question: "What is your real test? What is your cause?", Options: {0: "To become close with all my Pokémon! I love my Pokémon!", 1: "To have fun and go on adventures with my Pokémon! There's so much to explore with them!", 2: "To find the best possible ways to make my Pokémon the most powerful. Superior planning and intelligence will win our fights.", 3: "To catch them is my real test, to train them is my cause."}},
        19: {Question: "There is a festival going on in Cerulean City, but you're about to challenge the gym in Saffron City. You...", Options: {0: "Stop at the festival. The gym isn't going anywhere!", 1: "The festival might have important items to help me in my battle. Better check it out.", 2: "My Pokémon need a rest. I should take a nap at the PokéCenter.", 3: "The festival can wait! I've got a gym badge to earn!"}},
        20: {Question: "A stray cat appears in front of you. What do you do?", Options: {0: "Close enough to a Pokémon. Let's Battle!", 1: "Scan it with the Pokédex. What even is that?", 2: "Better leave it alone. Could be a dangerous legendary Pokémon.", 3: "Pet it, like I do with all new wild and possibly feral creatures."}},
    }
    useEffect(()=>{
        if (answer20){
    ...
    },[setNext, setQuestionAnswers, setQuestionsComplete, setShowQuestionnaire, setShowSignUp, setSubmit, answer1, answer2, answer3, answer4, answer5, answer6, answer7, answer8, answer9, answer10, answer11, answer12, answer13, answer14, answer15, answer16, answer17, answer18, answer19, answer20])
