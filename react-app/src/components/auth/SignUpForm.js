    ...
    <>
      <div className="signup-form">
        <div className="signup-header">
          <div className="signup-header-text">Get started with us!</div>
        </div>
          ...
          <form onSubmit={onSignUp}>
            <div className="signup-form-primary">
              ...
              <div className="signup-gender">
                <label className = "signup-gender-label">Gender</label>
                <select
                  className="gender-select-options"
                  name="gender"
                  id="selectoption"
              ...
              <div className="signup-pokemon">
                ...
                <select
                  className="pokemon-select-options"
                  name="pokemonId"
        ...
        {next && !submit && (
          <button onClick={handleClick} type="button" id="nextbutton">
